...
processes. The retrieval input consists of single-channel infrared observations
...
ingests the gridded IR observations at their native 0.036 degree and 30 min
resolution. Since the effective spatial resolution of the retrieved
precipitation can be expected to be much lower than the 0.036 degree of the
input observations, the model output is produced at half of the input spatial
resolution to reduce inference complexity as well as storage requirement. The
input consists of image patches of size 512 px x 512 px at 0.036 degree that are
mapped to precipitation estimates of size 256 px x 256 px with a resolution of
